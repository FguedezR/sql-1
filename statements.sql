...
SELECT edad FROM usuarios_lenguajes WHERE edad > 30;

-- Ejercicio 4: Contar cuántos usuarios saben JavaScript.
-- Tu respuesta aquí

SELECT * FROM usuarios_lenguajes WHERE lenguaje IN ('JavaScript');
...
SELECT * FROM usuarios_lenguajes WHERE lenguaje = 'Java' AND edad IN (25);

-- Ejercicio 8 OPCION 2: Contar cuántos usuarios con edades diferentes saben el lenguaje 'Java'.
-- Tu respuesta aquí

SELECT * FROM usuarios_lenguajes WHERE lenguaje IN 'Java';

-- Ejercicio 9: Seleccionar los usuarios que no saben ningún lenguaje.
-- Tu respuesta aquí

SELECT * FROM usuarios_lenguajes WHERE lenguaje IN ('');
...
SELECT nombre, apellido, COUNT(lenguaje) as cantidad_lenguajes FROM usuarios_lenguajes GROUP BY id_usuario;
...
SELECT COUNT(*) FROM usuarios_lenguajes WHERE edad BETWEEN 20 AND 25 AND lenguaje != '';
...
SELECT nombre, edad, (edad - (SELECT AVG(edad) FROM usuarios_lenguajes)) AS diferencia_promedio FROM usuarios_lenguajes;
...
SELECT nombre, LENGTH(nombre) AS longitud_nombre FROM usuarios_lenguajes WHERE lenguaje != '';
